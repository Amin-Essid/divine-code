<template>
  <div class="hero_about">
    ...
    <p>My favorite technologies are React js, Vue js and Node js.</p>
    <p>
      ...
      expertise, my knowledge, and my competence in order to achieve that dream.
    </p>
  </div>
</template>
